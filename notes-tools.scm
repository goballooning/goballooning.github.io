    ...
    `(entry 
        (!document 
            ...
            (link (@ (rel "alternate") (type "text/html") (hreflang "en") (href 
                ,(string-append "http://goballooning.github.io/notes/docs/" 
                                (string-drop-right file 3) ".html" ))))
            (id ,(string-append "goballooning.github.io/notes/" file ":" 
        ...
        `(*TOP* (!document 
            ...
            (feed (@ (xmlns "http://www.w3.org/2005/Atom") (xml:lang "en")) (!document
                ...
                (link (@ (rel "alternate") (type "text/html") 
                         (href "http://goballooning.github.io/notes")))
                (link (@ (rel "self") (type "application/atom+xml") 
                         (href "http://goballooning.github.io/notes/docs/notes.atom")))
                (updated ,(strftime "%Y-%m-%dT%H:%M:%SZ"  (gmtime (current-time))))
                (author (!document
                    (name "The Blogger Name")
                    (uri "http://www.goballooning.github.io")))
                (id "goballooning.github.io/notes,2022,11")
                (icon "http://goballooning.github.io/notes/misc/blog-icon.ico")
                (logo "http://goballooning.github.io/notes/misc/blog-icon.png")
